...
object CalendarsTable : Table("calendars") {
    ...
    val rsvpEnabled = bool("rsvp_enabled").default(false)
    val anonymousRsvpEnabled = bool("anonymous_rsvp_enabled").default(false)
...
object EventsTable : Table("events") {
    ...
    val etag = text("etag")
    val rsvpOverride = bool("rsvp_override").nullable()
    val anonymousRsvpOverride = bool("anonymous_rsvp_override").nullable()
